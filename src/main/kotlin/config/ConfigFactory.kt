...
class ConfigFactory(
    ...
    fun create(): Config {
        return Config(
            ...
            lowFilterCrossover = FilterCrossover(Notes.C.getFrequency(0), Notes.C.getFrequency(1)),
            highFilterCrossover = FilterCrossover(Notes.C.getFrequency(2), Notes.C.getFrequency(3)),
            sampleSize = 4100,
