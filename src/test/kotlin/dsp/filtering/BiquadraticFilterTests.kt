...
class BiquadraticFilterTests {
    ...
    fun `input from two steps ago is scaled by b2`() {
        ...
        assertArrayEquals(floatArrayOf(0f, 0f, 1f, 2f), output)
    }
    ...
    fun `output from two steps ago is scaled by a2`() {
        ...
        // y[3] = 0 - (-0.5 * 0) = 0
        // y[4] = 0 - (-0.5 * 0.5) = 0.25
        assertArrayEquals(floatArrayOf(1f, 0f, 0.5f, 0f, 0.25f), output)
    }
    ...
    fun `state carries across consecutive calls`() {
        ...
        assertArrayEquals(floatArrayOf(2f, 5f), output2)
    }
