...
class AudioInputTileViewModelTests {
    ...
    private val audioInputManager: AudioInputManager = mockk(relaxed = true)
    ...
    @Test
    fun `when connect fails with a message, then show the message`() {
        val sut = createSUT()
    ...
    @Test
    fun `when connect fails without a message, then show a generic error`() {
        val sut = createSUT()
    ...
    @Test
    fun `when disconnect fails with a message, then show the message`() = runTest {
        val sut = createSUT()
    ...
    @Test
    fun `when disconnect fails without a message, then show a generic error`() = runTest {
        val sut = createSUT()
